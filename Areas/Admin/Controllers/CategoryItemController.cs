...
namespace WebApplication1.Areas.Admin.Controllers
{
    ...
    public class CategoryItemController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,CategoryId,Description,MediaTypeId,DateTimeItemReleased")] CategoryItem categoryItem)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,CategoryId,Description,MediaTypeId,DateTimeItemReleased")] CategoryItem categoryItem)
        {
